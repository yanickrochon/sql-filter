...
const $operBuiltin = Symbol('operator');
const $operCustom = Symbol('custom');
...
module.exports = class Adapter {
  ...
  getOperatorHandler(operator) {
    ...
    return this[$operBuiltin][operator] || this[$operCustom][operator] || this[$operBuiltin][DEFAULT_OPERATOR];
  }
